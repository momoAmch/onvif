...
export type BarcodeType = 'Code-39' | 'Code-49' | 'Code-93' | 'Code-128' | 'Code-11' | 'Code-25-Interleaved' | 'Code-25-NonInterleaved' | 'DataMatrix' | 'Maxicode' | 'Postnet' | 'RM4SCC' | 'ISBN-13' | 'ISBN-13-Dual' | 'ISBN-10' | 'ITF-14' | 'EAN-2' | 'EAN-2' | 'EAN-8' | 'EAN-13' | 'EAN-14' | 'EAN-18' | 'EAN-99' | 'EAN-128' | 'SCC-14' | 'SSCC-18' | 'UPC-A' | 'UPC-E' | 'PDF417' | 'QRCode';
