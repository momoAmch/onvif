import {
    AttachmentData, AuxiliaryData,
    BackupFile,
    CapabilityCategory, Certificate, CertificateInformation, CertificateStatus, CertificateWithPrivateKey,
    DateTime,
    DeviceEntity,
    DiscoveryMode,
    DNSInformation, DNSName, Dot11AvailableNetworks, Dot11Capabilities, Dot11Status, Dot1XConfiguration,
    DynamicDNSInformation,
    DynamicDNSType,
    FactoryDefaultType,
    HostnameInformation,
    IntList,
    IPAddress, IPAddressFilter, IPv4Address, IPv6Address, NetworkGateway,
    NetworkHost, NetworkInterface, NetworkInterfaceSetConfiguration, NetworkProtocol, NetworkZeroConfiguration,
    NTPInformation,
    OnvifVersion, RelayLogicalState, RelayOutput, RelayOutputSettings,
    RemoteUser,
    Scope,
    SetDateTimeType,
    StringAttrList,
    ...
    SystemDateTime,
    SystemLog,
    SystemLogType, SystemLogUriList,
    TimeZone,
    User
} from "./onvif";
import { AnyURI } from "./interface";
import {IntRange, LocationEntity, ReferenceToken} from "./common";
